...
public class DrawingCanvas extends Canvas {
	...
	public void paint(Graphics g, int fps){
        ...
        if(GameStatus.menu) {
        	g.drawImage(StarScrapMain.logo, (int)getWidth()/8, 0, (int)((getWidth()/4)*3), (int)((getHeight()/4)*3), null);
        	g.drawImage(StarScrapMain.oneVOne, (int)(getWidth()/5), (int)getHeight()/5*3, (int)(getWidth()/5), (int)(getHeight()/5), null);
        }
	}
